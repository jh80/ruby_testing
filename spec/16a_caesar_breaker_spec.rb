...
describe CaesarBreaker do
  ...
  describe '#create_decrypted_messages' do
    ...
    # I CAN'T TELL IF THIS  IS NECESSARY, THE TEST PASSES WITH OUT IT, BUT MAYBE IT IS A BAD TEST
    before do
  ...
  describe '#save_decrypted_messages' do
    ...
    context 'when the directory does not exist' do
      ...
      # I don't feel comfortable enough with after block to use this, but
      # when I commented out phrase.save_decrypted_message from the examples
      # it worked
      # 
      # after do
      #   phrase.save_decrypted_messages
